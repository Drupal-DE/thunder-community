...
namespace Drupal\thunder_forum_reply\Plugin\migrate\destination;
 ...
 * )
 */
class EntityForumReply extends EntityContentBase {
  ...
  /**
   * An array of entity IDs for the 'replied entity' keyed by entity type.
   *
   * @var array
   */
  protected $stubRepliedEntityIds;

  /**
   * Builds a forum reply entity destination.
   *
  ...
  public function import(Row $row, array $old_destination_id_values = array()) {
    ...
    if ($row->isStub() && $state) {
      $this->state->set('thunder_forum_reply.maintain_node_statistics', $state);
    }
